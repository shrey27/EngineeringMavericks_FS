...
/**
 * All the routes related to User's watch later are present here.
 * These are private routes.
 * Client needs to add "authorization" header with JWT token in it to access it.
 * */

/**
 * This handler handles getting videos from user's watch later video.
...
/**
 * This handler handles adding videos to user's watch later list.
...
/**
 * This handler handles removing videos from user's watch later list.
